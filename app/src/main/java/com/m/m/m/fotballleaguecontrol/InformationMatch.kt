...
import com.m.m.m.fotballleaguecontrol.fragments.TeamsFragment

class InformationMatch : AppCompatActivity() {
    ...
    private fun setupViewPager(viewpager: ViewPager) {
        ...
        // is a title of tab
        adapter.addFragment(TeamsFragment(), "Local")
        adapter.addFragment(TeamsFragment(), "Visitante")
